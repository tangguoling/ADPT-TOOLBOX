...
4. Open a terminal and enter the folder where the GUI_v8.py is located. Please make sure that config.yaml and config_predict.yaml is under the same folder of GUI_v8.py because script would read training configuration from them.
